...
# --- Garantir que o Matplotlib use backend "Agg" (compatível com servidores/headless) ---
# e evitar problemas de permissão ao criar cache de fontes
...
def render_gauge_matplotlib(score: float, title: str='Temperatura da Pauta',
    ...
    try:
        ...
        st.error(f"Falha ao carregar Matplotlib: {e}. Tente instalar/atualizar o pacote 'matplotlib'.")
        return None
...
st.subheader("Gauges")
try:
    import plotly  # se presente, usamos plotly
    use_plotly = True
except Exception:
    use_plotly = False
